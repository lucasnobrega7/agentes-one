    ...
    return (
        <>
            ...
            <Card sx={{ borderColor: theme.palette.primary[200] + 75, p: 3, mt: 2 }} variant='outlined'>
                ...
                {textField(title, 'title', 'Title', 'string', 'Agentes de Conversão')}
                {textField(
                    titleAvatarSrc,
                    'titleAvatarSrc',
                    'Title Avatar Link',
                    'string',
                    `https://raw.githubusercontent.com/agentesdeconversao/agentes/main/assets/AgentesDeConversao_dark.png`
                )}
