...
export const defaultThemeConfig = {
    ...
    disclaimer: {
        title: 'Disclaimer',
        message: 'By using this chatbot, you agree to the <a target="_blank" href="https://agentesdeconversao.com.br/terms">Terms & Condition</a>',
        textColor: 'black',
        buttonColor: '#3b82f6',
    ...
    chatWindow: {
        ...
        title: 'Agentes de Conversão Bot',
        ...
        footer: {
            textColor: '#303235',
            text: 'Powered by',
            company: 'Agentes de Conversão',
            companyLink: 'https://agentesdeconversao.com.br'
        }
    }
}
