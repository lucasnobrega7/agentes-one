                ...
                inputParams: [
                    {
                        ...
                        type: 'string',
                        description:
                            'If not specified, a random id will be used. Learn <a target="_blank" href="https://docs.agentesdeconversao.com.br/memory#ui-and-embedded-chat">more</a>',
                        default: '',
            ...
            data: {
                ...
                inputParams: [
                    ...
                    },
                    {
                        ...
                        type: 'boolean',
                        description:
                            'Allow image input. Refer to the <a href="https://docs.agentesdeconversao.com.br/using-agentes/uploads#image" target="_blank">docs</a> for more details.',
                        default: false,
                        optional: true,
