        ...
        <Stack direction='column' spacing={2} sx={{ alignItems: 'start' }}>
            <Typography variant='h3'>
                ...
                <TooltipWithParser
                    ...
                    title={
                        'Enable or disable which properties of the flow configuration can be overridden. Refer to the <a href="https://docs.agentesdeconversao.com.br/using-agentes/api#override-config" target="_blank">documentation</a> for more information.'
                    }
                />
            </Typography>
