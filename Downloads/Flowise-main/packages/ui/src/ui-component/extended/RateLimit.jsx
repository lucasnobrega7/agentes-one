        ...
        <Stack direction='column' spacing={2} sx={{ alignItems: 'start' }}>
            <Typography variant='h3'>
                ...
                <TooltipWithParser
                    style={{ marginLeft: 10 }}
                    title={
                        'Visit <a target="_blank" href="https://docs.agentesdeconversao.com.br/configuration/rate-limit">Rate Limit Setup Guide</a> to set up Rate Limit correctly in your hosting environment.'
                    }
                />
            </Typography>
